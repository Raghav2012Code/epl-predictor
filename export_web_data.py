...
CLUB_METADATA: Dict[str, Dict[str, str]] = {
    "Arsenal": {"short": "ARS", "color": "#EF0107", "stadium": "Emirates Stadium", "badge": "badges/arsenal.png"},
    "Aston Villa": {"short": "AVL", "color": "#95BFE5", "stadium": "Villa Park", "badge": "badges/aston-villa.png"},
    "Bournemouth": {"short": "BOU", "color": "#DA291C", "stadium": "Vitality Stadium", "badge": "badges/bournemouth.png"},
    "Brentford": {"short": "BRE", "color": "#E30613", "stadium": "Gtech Community Stadium", "badge": "badges/brentford.png"},
    "Brighton": {"short": "BHA", "color": "#0057B8", "stadium": "Amex Stadium", "badge": "badges/brighton.png"},
    "Chelsea": {"short": "CHE", "color": "#034694", "stadium": "Stamford Bridge", "badge": "badges/chelsea.png"},
    "Crystal Palace": {"short": "CRY", "color": "#1B458F", "stadium": "Selhurst Park", "badge": "badges/crystal-palace.png"},
    "Everton": {"short": "EVE", "color": "#003399", "stadium": "Goodison Park", "badge": "badges/everton.png"},
    "Fulham": {"short": "FUL", "color": "#FFFFFF", "stadium": "Craven Cottage", "badge": "badges/fulham.png"},
    "Ipswich": {"short": "IPS", "color": "#0053A0", "stadium": "Portman Road", "badge": "badges/ipswich.png"},
    "Leeds": {"short": "LEE", "color": "#FFCD00", "stadium": "Elland Road", "badge": "badges/leeds.png"},
    "Liverpool": {"short": "LIV", "color": "#C8102E", "stadium": "Anfield", "badge": "badges/liverpool.png"},
    "Manchester City": {"short": "MCI", "color": "#6CABDD", "stadium": "Etihad Stadium", "badge": "badges/man-city.png"},
    "Manchester United": {"short": "MUN", "color": "#DA291C", "stadium": "Old Trafford", "badge": "badges/man-utd.png"},
    "Newcastle": {"short": "NEW", "color": "#241F20", "stadium": "St. James' Park", "badge": "badges/newcastle.png"},
    "Nottingham Forest": {"short": "NFO", "color": "#DD0000", "stadium": "City Ground", "badge": "badges/nottingham-forest.png"},
    "Sunderland": {"short": "SUN", "color": "#EB172B", "stadium": "Stadium of Light", "badge": "badges/sunderland.png"},
    "Tottenham": {"short": "TOT", "color": "#132257", "stadium": "Tottenham Hotspur Stadium", "badge": "badges/tottenham.png"},
    "Coventry": {"short": "COV", "color": "#0099FF", "stadium": "Coventry Building Society Arena", "badge": "badges/coventry.png"},
    "Hull": {"short": "HUL", "color": "#FFA500", "stadium": "MKM Stadium", "badge": "badges/hull.png"},
}
...
def build_web_dataset() -> str:
        ...
        fixtures.append(
            {
                ...
                "homeBadge": CLUB_METADATA.get(ht, {}).get("badge", ""),
                "awayBadge": CLUB_METADATA.get(at, {}).get("badge", ""),
    ...
    for club in CLUB_METADATA.keys():
        standings_map[club] = {
            ...
            "badge": CLUB_METADATA[club].get("badge", ""),
            "played": 0,
            "won": 0,
            "drawn": 0,
            "lost": 0,
