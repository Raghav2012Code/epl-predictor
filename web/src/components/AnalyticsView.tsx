    ...
    <div className="overflow-x-auto">
      <div className="min-w-[620px] bg-background border border-border-subtle rounded-sm p-2.5">
        <svg viewBox={`0 0 ${data.length * 18 + 40} 190`} className="w-full h-48" role="img" aria-label="Predicted goals per gameweek">
            ...
            return (
              <g key={d.gw}>
                ...
                {(d.gw === 1 || d.gw % 5 === 0 || d.gw === 38) && (
                  <text x={x + 6} y="182" textAnchor="middle" fontSize="8" fill="#b2cdc4" fontFamily="monospace">
                    {d.gw}
                  </text>
                )}
              </g>
          ...
          <text x="4" y="36" fontSize="8" fill="#b2cdc4" fontFamily="monospace">{maxGoals}</text>
          <text x="4" y="172" fontSize="8" fill="#b2cdc4" fontFamily="monospace">0</text>
        </svg>
